class Deadline < ApplicationRecord
  ...
  validate :min_distance_is_less_than_shipping_option_max_distance
  ...
  def min_distance_is_less_than_shipping_option_max_distance
    if self.min_distance.present? && self.min_distance >= self.shipping_option.max_distance
      self.errors.add(:min_distance, "deve ser menor que #{self.shipping_option.min_distance}")
    end
  end
end
