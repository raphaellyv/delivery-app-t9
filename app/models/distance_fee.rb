class DistanceFee < ApplicationRecord
  belongs_to :shipping_option

  validates :fee, :max_distance, :min_distance, presence: true
  validates :min_distance, comparison: { less_than: :max_distance }
  validates :fee, numericality: { greater_than: 0 }
  validates :fee, :max_distance, :min_distance, uniqueness: { scope: :shipping_option }
