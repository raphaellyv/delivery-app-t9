...
order_c = Order.create!(delivery_address: 'Rua das Palmeiras, 13', delivery_city: 'Rio de Janeiro', delivery_state: 'RJ', 
                        delivery_postal_code: '28200000', recipient: 'Denise Silva', recipient_cpf: '00000000000',
...
DetailedOrder.create!(order: order_a, shipping_option: so_a, total_price: 905.50, vehicle: vehicle_a,
                      estimated_delivery_date: Time.now - 48.hours, delivery_date: Time.now - 48.hours)
...
DetailedOrder.create!(order: order_c, shipping_option: so_b, total_price: 453.00, vehicle: vehicle_b,
